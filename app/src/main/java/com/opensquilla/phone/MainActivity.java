...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 首次启动进入引导页
        SharedPreferences prefs = getSharedPreferences("opensquilla", MODE_PRIVATE);
    ...
    private void maybeCheckUpdate() {
        final SharedPreferences prefs = getSharedPreferences("opensquilla", MODE_PRIVATE);
        ...
        new Thread(() -> {
            ...
            runOnUiThread(() -> new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("更新", (d, w) -> AboutDialog.openBrowser(
                            this, "https://github.com/qiannianhuanxiang/OpenSquilla/releases/latest"))
    ...
    private void maybeShowBackupReminder() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setMessage("已启动 " + count + " 次，建议把配置和对话记录导出到\n"
                        + "Download/OpenSquilla 备份，防止意外丢失。")
                .setView(box)
