...
public class PluginFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        hideCb.setChecked(requireContext().getSharedPreferences("opensquilla", android.content.Context.MODE_PRIVATE)
    ...
    private void showInstalled() {
        final boolean hide = requireContext().getSharedPreferences("opensquilla", android.content.Context.MODE_PRIVATE)
                .getBoolean("hide_builtin", false);
        new Thread(() -> {
            ...
            for (int base = 0; base < size; base += 80) {
                ...
                for (String u : urls) {
                    try {
                        ...
                        conn.setRequestProperty("User-Agent", "OpenSquilla/1.1.0-mobile");
